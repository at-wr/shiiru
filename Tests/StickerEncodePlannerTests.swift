...
final class StickerEncodePlannerTests: XCTestCase {
    ...
    func testHoldsFPSWhileResolutionFalls() {
        ...
        XCTAssertLessThanOrEqual(attemptsAt30.last?.side ?? 512, 256)
    }
    ...
    func testRespectsFloorsAndTierOrder() {
        for all in [
            ...
            for plan in all {
                ...
                XCTAssertGreaterThanOrEqual(plan.side, 192)
            }
    ...
    func testDenseVideoGetsEmergencyTierInsteadOfStatic() {
        ...
        XCTAssertLessThanOrEqual(Int(3.0 * 12) * (256 * 256 / 6), 500_000)
    }
    ...
    func testFPSTierDropCanRaiseResolutionBack() throws {
        ...
        XCTAssertGreaterThan(dropped.side, 192, "fewer frames should buy some resolution back")
    }
}
